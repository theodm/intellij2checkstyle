...
internal class MultipleProfilesWithOverrideTest {

    @Test
    @ResourceLocation("multiple_profiles")
    @DisplayName(
        "Project with multiple project profiles and a profile override " +
            "which specifies the profile to be used"
    )
    fun testAny(
